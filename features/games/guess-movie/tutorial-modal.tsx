...
const LEGEND = [
  {
    cls: "fr-tile--correct",
    title: "Green — exact",
    body: "The attribute matches the secret film exactly.",
  },
  {
    cls: "fr-tile--close",
    title: "Amber — close",
    body: "Within range: year ±5, rating ±0.5, or box office in the ballpark.",
  },
  {
    cls: "fr-tile--wrong",
    title: "Grey — cold",
    body: "No match. Numeric tiles show ↑ / ↓ toward the secret value.",
  },
];
